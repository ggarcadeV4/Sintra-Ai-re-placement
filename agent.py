...
def run(
    user_message: str, state: AgentState, config: dict,
    system_prompt: str, depth: int = 0, cancel_check=None,
) -> Generator:
    ...
    while True:
        ...
        for event in stream(
            ...
            messages=state.messages, tool_schemas=get_tool_schemas(), config=config,
        ):
        ...
        state.messages.append({
            "role": "assistant", "content": assistant_turn.text,
