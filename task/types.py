...
class Task:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "active_form": self.active_form, "owner": self.owner,
    ...
    def from_dict(cls, data: dict) -> "Task":
        ...
        return cls(
            ...
            active_form=data.get("active_form", ""), owner=data.get("owner", ""),
    ...
    def one_line(self, resolved_ids=None) -> str:
        owner_str = f" ({self.owner})" if self.owner else ""
        pending_blockers = [b for b in self.blocked_by if resolved_ids is None or b not in resolved_ids]
